-- ============================================================================
-- QA / DEMO Seed Data — EduZone v13  (OPT-IN ONLY — deploy.js skips this file)
-- ============================================================================
-- EVERYTHING here is disposable test data: @eduzone-test.com and
-- @test.eduzone.local accounts (shared committed bcrypt password — see
-- .github/workflows/e2e.yml), QA/demo tenants, demo courses/lessons/
-- contents, enrollments, progress, warnings, notifications, feature-flag
-- overrides, devices, activity logs, access rules, sample rate-limit rows,
-- todos, locations.
-- deploy.js applies this ONLY with ALLOW_QA_SEED_DATA=true, and that flag
-- must never be set against staging/production: it would plant
-- known-password accounts and pollute the catalog with demo content.
-- The super_admin account is NOT here — it is seeded unconditionally by
-- 11_seed_reference.sql (PHASE 0B).
-- ============================================================================
