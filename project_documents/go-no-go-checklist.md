...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Playwright E2E tests pass (4 spec files / 17 tests: auth login+logout+token-version, user list & filters, a11y audits, UX/RTL/keyboard regression)                                                                    | QA    | ✅      | Run: `pnpm --filter @eduzone/admin exec playwright test`. Verified green in CI: [E2E (Playwright) #22](https://github.com/mi9092921-alt/EduZone_dashboard/actions/runs/33973022592/job/101324780761) — 17 passed (1.5m), no flaky, commit `4a4e87f`, 2026-09-05. Gate live in `.github/workflows/e2e.yml` (`E2E_ENABLED=true`). |
