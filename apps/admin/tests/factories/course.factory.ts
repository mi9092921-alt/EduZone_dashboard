...
function nextCourseId(): string {
  return `course-${String(_courseCounter++).padStart(4, '0')}`;
}
function nextSectionId(): string {
  return `section-${String(_sectionCounter++).padStart(4, '0')}`;
}
function nextLessonId(): string {
  return `lesson-${String(_lessonCounter++).padStart(4, '0')}`;
}
function nextEnrollmentId(): string {
  return `enroll-${String(_enrollmentCounter++).padStart(4, '0')}`;
}
